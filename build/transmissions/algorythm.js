...
var applyTransmission = function applyTransmission(state, req, replacements) {
...
var replaceValueInRequest = function replaceValueInRequest(requestPattern, value, valueName) {
	var inUrl = false;
...
var setNewTransmission = function setNewTransmission(done) {
	var transmission = {};
	var saveOnEnd = false;
